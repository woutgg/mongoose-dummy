...
let getPaths = (model) => {
    ...
    let _generateReturnObj = (path, name, schema, context) => { /* Generate definition for a single path */
        ...
        if (path.instance.toLowerCase() === "embedded") {
             result.embeddedDefinition = getPaths(path.schema);
        }
    ...
    for (let field in paths) { /* Loop over paths and generated data */
        ...
        if (desc.isEnum) { /* Handle enumerations paths */
            ...
            if (hasCustom && type === "string") { /* Handle custom paths */
                let isCustom = false;
                if (opts.custom.email && opts.custom.email.field === field) {
                    generated[field] = emailGenerator();
                    isCustom = true;
                } else if (opts.custom.phone && opts.custom.phone.field === field) {
                    generated[field] = phoneGenerator();
                    isCustom = true;
                } else if (opts.custom.address && opts.custom.address.field === field) {
                    generated[field] = addressGenerator();
                    isCustom = true
                } else if (opts.custom.password && opts.custom.password.field === field) {
            ...
            if (type === "string") {
                ...
                generated[field] = generateRandomModel(desc.embeddedDefinition, opts);
            } else {
